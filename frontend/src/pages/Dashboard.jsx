    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.headerContainer}>
        <div className={dashboardStyles.headerContent}>
          <div>
            <h1 className={dashboardStyles.headerTitle}>Finance Dashborad</h1>
            <p className={dashboardStyles.headerTitle}>
                ...
                >
                  ...
                  <div className={dashboardStyles.transactionAmount}>
                    ...
                    <p className={dashboardStyles.transactionDate}>
                      {new Date(transaction.date).toLocaleDateString("es-GB")}
                    </p>
                  </div>
                </div>
              );
