...
import { sidebarStyles, cn } from "../assets/dummyStile";
...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
  ...
  const inital = username.charAt(0).toUpperCase();
  ...
  // click outside sidebar get collapse
  useEffect(() => {
        ...
        <div className={sidebarStyles.sidebarInner.base}>
          ...
          >
            <div className="flex items-center ">
              <div className={sidebarStyles.userInitials.base}>{inital}</div>
              {!isCollapsed && (
                <motion.div
