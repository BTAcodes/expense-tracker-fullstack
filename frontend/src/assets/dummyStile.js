...
export const profileStyles = {
  ...
  input:
    "w-full px-4 py-2 bg-white border border-gray-300 rounded-lg placeholder:text-gray-500 focus:ring-2 focus:ring-teal-300 focus:border-teal-500 plaseholder:text-gray-500",
  inputWithError:
    "w-full px-4 py-2 bg-gray-50 border rounded-lg placeholder:text-gray-500 focus:ring-2 focus:ring-teal-300 focus:border-teal-500",
...
export const modalStyles = {
  ...
  form: "space-y-4",
  label:
    "block text-sm font-medium text-gray-700 mb-1 placeholder:text-gray-500",
  input: (ringColor) =>
    `w-full border border-gray-200 rounded-lg px-4 py-2 placeholder:text-gray-500 focus:outline-none focus:ring-2 ${ringColor}`,
...
export const loginStyles = {
  ...
  input:
    "w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-teal-500 placeholder:text-gray-500",
  passwordInput:
    "w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-teal-500 placeholder:text-gray-500",
  passwordToggle:
    "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
...
export const signupStyles = {
  ...
  inputIcon:
    "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400",
  input:
    "w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-teal-500 placeholder:text-gray-400",
  passwordInput:
    "w-full pl-10 pr-10 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-teal-300 focus:border-teal-500 placeholder:text-gray-400",
  passwordToggle:
    "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
